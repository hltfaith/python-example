...
select student.sname,course.cname from student,score,course where score.student_id=student.sid and score.course_id=course.cid and student.sid=2 order by score desc limit 1;
select student.sname,course.cname,score.score from student,score,course where score.student_id=student.sid and score.course_id=course.cid and student.sid=2 order by score asc limit 1;
